...
#depth= 3 FN= 585 Neoron= [490, 411, 345] Regulization= 1.0791229413615787e-06
#Learning_Rate = 0.0035292103726574675
...
def getmodel(inpudim,sid):
    ...
    regulization = 1.0791229413615787e-06
...
#    learning_rate_stop = 5e-5
    ...
    main_output =  ks.layers.Dense(1050,name='main_output',use_bias=True,kernel_regularizer = tf.keras.regularizers.l2(regulization),activation='linear')(full)
