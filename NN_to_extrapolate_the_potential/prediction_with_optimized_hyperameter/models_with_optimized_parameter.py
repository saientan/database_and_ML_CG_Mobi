...
#depth= 4 FN= 499 Neoron= [453, 411, 373, 338] Regulization= 1.4280078163203768e-06
#Learning_Rate = 0.0011017540366192419
...
def getmodel(inpudim,sid):
    ...
    regulization=1.4280078163203768e-06
...
#    learning_rate_stop = 5e-5
    ...
    main_output =  ks.layers.Dense(200,name='main_output',use_bias=True,kernel_regularizer = tf.keras.regularizers.l2(regulization),activation='linear')(full)
